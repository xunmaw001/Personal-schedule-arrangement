<template>
	<view class="content">
		<form class="app-update-pv">
				...
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(51, 51, 51, 1)","textAlign":"center"}' class="title">会面编号</view>
				...
				<picker mode="date" :value="ruleForm.gongzuoshijian" @change="gongzuoshijianChange">
					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"8rpx","color":"rgba(51, 51, 51, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"26rpx","borderStyle":"solid","height":"60rpx"}' class="uni-input">{{ruleForm.gongzuoshijian?ruleForm.gongzuoshijian:"请选择工作时间"}}</view>
												...
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group select">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(51, 51, 51, 1)","textAlign":"left"}' class="title">会面时间</view>
				<picker mode="date" :value="ruleForm.huimianshijian" @change="huimianshijianChange">
					<view :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"8rpx","color":"rgba(51, 51, 51, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"26rpx","borderStyle":"solid","height":"60rpx"}' class="uni-input">{{ruleForm.huimianshijian?ruleForm.huimianshijian:"请选择会面时间"}}</view>
				</picker>
			</view>
												<view :style='{"boxShadow":"0 0 16rpx rgba(0,0,0,.3)","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"#ccc","margin":"0 0 20rpx 0","borderWidth":"0","borderStyle":"solid","height":"108rpx"}' class="cu-form-group">
				<view :style='{"width":"170rpx","fontSize":"28rpx","color":"rgba(51, 51, 51, 1)","textAlign":"center"}' class="title">会面地点</view>
				<input :style='{"boxShadow":"0 0 0px rgba(0,0,0,.6) inset","backgroundColor":"rgba(255, 255, 255, 0)","borderColor":"rgba(0,0,0,.6)","borderRadius":"8rpx","color":"rgba(51, 51, 51, 1)","textAlign":"left","borderWidth":"2rpx","fontSize":"26rpx","borderStyle":"solid","height":"60rpx"}' :disabled="ro.huimiandidian" v-model="ruleForm.huimiandidian" placeholder="会面地点"></input>
			</view>
	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`huimian`, this.ruleForm.id);
			...
			if(options.cross){
				...
				for (var o in obj){
					if(o=='huimianbianhao'){
					this.ruleForm.huimianbianhao = obj[o];
					this.ro.huimianbianhao = true;
					continue;
					}
					...
					if(o=='huimianshijian'){
					this.ruleForm.huimianshijian = obj[o];
					this.ro.huimianshijian = true;
					continue;
					}
					if(o=='huimiandidian'){
					this.ruleForm.huimiandidian = obj[o];
					this.ro.huimiandidian = true;
					continue;
					}
					if(o=='tupian'){
		...
		methods: {
			...
			// 多级联动参数
				...
				this.$forceUpdate();
												...
												huimianshijianChange(e) {
				this.ruleForm.huimianshijian = e.target.value;
				this.$forceUpdate();
			},
			...
			async onSubmitTap() {
																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																																								if(this.ruleForm.id){
					await this.$api.update(`huimian`, this.ruleForm);
				}else{
					await this.$api.add(`huimian`, this.ruleForm);
				}
