	...
	export default {
		...
		async onLoad(options) {
			...
			if (options.id) {
				...
				// 获取信息
				res = await this.$api.info(`gongzuoricheng`, this.ruleForm.id);
		...
		methods: {
			...
			async onSubmitTap() {
					...
					return
																																																																																																																																																																																				...
																																																																																																																																																																																				if(this.ruleForm.id){
					await this.$api.update(`gongzuoricheng`, this.ruleForm);
				}else{
					await this.$api.add(`gongzuoricheng`, this.ruleForm);
				}
