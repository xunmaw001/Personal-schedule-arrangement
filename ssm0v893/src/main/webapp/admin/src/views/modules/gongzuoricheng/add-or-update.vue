  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.richengbianhao" label="日程编号" prop="richengbianhao">
              <el-input v-model="ruleForm.richengbianhao" 
                placeholder="日程编号" readonly></el-input>
          </el-form-item>
        </div>
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `gongzuoricheng/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.gongzuorichengCrossAddOrUpdateFlag = false;
                  this.parent.search();
