<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="用餐编号" prop="yongcanbianhao">
            <el-input v-model="ruleForm.yongcanbianhao" 
                placeholder="用餐编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yongcanbianhao" label="用餐编号" prop="yongcanbianhao">
              <el-input v-model="ruleForm.yongcanbianhao" 
                placeholder="用餐编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="用餐时间" prop="yongcanshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.yongcanshijian" 
                type="date"
                placeholder="用餐时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.yongcanshijian" label="用餐时间" prop="yongcanshijian">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="用餐地点" prop="yongcandidian">
          <el-input v-model="ruleForm.yongcandidian" 
              placeholder="用餐地点" clearable  :readonly="ro.yongcandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="用餐地点" prop="yongcandidian">
              <el-input v-model="ruleForm.yongcandidian" 
                placeholder="用餐地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `yongcan/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.yongcanCrossAddOrUpdateFlag = false;
                  this.parent.search();
