<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'" label="会面编号" prop="huimianbianhao">
            <el-input v-model="ruleForm.huimianbianhao" 
                placeholder="会面编号" readonly></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huimianbianhao" label="会面编号" prop="huimianbianhao">
              <el-input v-model="ruleForm.huimianbianhao" 
                placeholder="会面编号" readonly></el-input>
          </el-form-item>
        </div>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="工作名称" prop="gongzuomingcheng">
          <el-input v-model="ruleForm.gongzuomingcheng" 
              placeholder="工作名称" clearable  :readonly="ro.gongzuomingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="工作名称" prop="gongzuomingcheng">
              <el-input v-model="ruleForm.gongzuomingcheng" 
                placeholder="工作名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="会面时间" prop="huimianshijian">
            <el-date-picker
                format="yyyy 年 MM 月 dd 日"
                value-format="yyyy-MM-dd"
                v-model="ruleForm.huimianshijian" 
                type="date"
                placeholder="会面时间">
            </el-date-picker> 
        </el-form-item>
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.huimianshijian" label="会面时间" prop="huimianshijian">
              <el-input v-model="ruleForm.huimianshijian" 
                placeholder="会面时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="会面地点" prop="huimiandidian">
          <el-input v-model="ruleForm.huimiandidian" 
              placeholder="会面地点" clearable  :readonly="ro.huimiandidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="会面地点" prop="huimiandidian">
              <el-input v-model="ruleForm.huimiandidian" 
                placeholder="会面地点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huimian/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huimianCrossAddOrUpdateFlag = false;
                  this.parent.search();
