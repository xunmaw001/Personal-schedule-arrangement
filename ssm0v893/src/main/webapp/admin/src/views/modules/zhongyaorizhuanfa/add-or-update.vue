<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="序号" prop="xuhao">
          <el-input v-model="ruleForm.xuhao" 
              placeholder="序号" clearable  :readonly="ro.xuhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="序号" prop="xuhao">
              <el-input v-model="ruleForm.xuhao" 
                placeholder="序号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="倒数天" prop="daoshutian">
          <el-input v-model="ruleForm.daoshutian" 
              placeholder="倒数天" clearable  :readonly="ro.daoshutian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="倒数天" prop="daoshutian">
              <el-input v-model="ruleForm.daoshutian" 
                placeholder="倒数天" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容" prop="neirong">
                <el-input
  ...
  methods: {
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zhongyaorizhuanfa/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zhongyaorizhuanfaCrossAddOrUpdateFlag = false;
                  this.parent.search();
